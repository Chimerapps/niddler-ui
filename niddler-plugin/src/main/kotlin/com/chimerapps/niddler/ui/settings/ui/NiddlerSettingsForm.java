...
public class NiddlerSettingsForm {
    ...
    public JButton testConfigurationButton;
    JTextPane resultsPane;
    public JBLabel pathToAdbLabel;
    public JBLabel pathToiDeviceLabel;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        pathToAdbLabel = new JBLabel();
        pathToAdbLabel.setText("Path to adb:");
        root.add(pathToAdbLabel,
        ...
        pathToiDeviceLabel = new JBLabel();
        pathToiDeviceLabel.setText("Path to idevice binaries:");
        root.add(pathToiDeviceLabel,
